...
export const RateBuckets = {
  ...
  TOCCATA_LAB_GIVEAWAY_ENTRY: "toccata-lab.giveaway-entry",
  TOCCATA_LAB_GIVEAWAY_MUTATION: "toccata-lab.giveaway-mutation",
...
export const RateLimits = {
  ...
  [RateBuckets.TOCCATA_LAB_GIVEAWAY_ENTRY]: { limit: 8, windowMs: 60_000 },
  [RateBuckets.TOCCATA_LAB_GIVEAWAY_MUTATION]: { limit: 12, windowMs: 60_000 },
