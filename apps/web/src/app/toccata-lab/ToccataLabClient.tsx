...
export function ToccataLabClient({
  ...
  const shareReady = labLink?.status === "funded" || labLink?.status === "shared";
    ...
    },
    {
      ...
      state:
        labLink?.status === "awaiting_funding"
          ? "active"
          : shareReady || labLink?.status === "claimed" || labLink?.status === "refundable"
            ? "done"
            : "locked",
            ...
            <section className="card claimable-lab-panel">
              ...
              <form className="claimable-lab-form" onSubmit={createLabLink}>
                ...
                <p className="notice notice-warn">
                  After funding, save the private refund link. If nobody claims before the timer
                  ends, that refund link is the only way to recover the unclaimed KAS.
                </p>
              ...
              {labLink ? (
                <>
                  ...
                  <div className="claimable-action-row">
                    <button
                      className="btn"
                      disabled={!labLink.fundingAddress}
